...
public class EjemploLayout extends javax.swing.JFrame {

    /**
     * Creates new form EjemploLayout
     */
    /* CONSTRUCTOR PARA BORDER LAYOUT
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EjemploLayout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EjemploLayout().setVisible(true);
            }
        });
    }
